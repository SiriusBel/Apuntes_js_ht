...
console.log(name, lastName, age) ➟ Paula Sanchez 44 <!-- el name aparece tachado porque js lo reconoce como una palabra reservada, pero en este caso está en desuso (hay una lista en los apuntes de palabras reservadas) -->
...
- La capitalización es muy importane, a la hora de la lectura, EXISTE como diferencia, es case sensitive "manzana" es distinto a "MANZANA".
